...
import { GITHUB_LINK, GMAIL_LINK } from "@/helpers/constants";
    ...
    <div className="flex gap-5 items-center justify-center flex-col md:flex-row mt-0 md:mt-[calc(33vh-100px)] ">
      <div className="flex items-center md:items-start flex-[0.6] flex-col gap-6 order-2 md:order-1">
        ...
        <p className="leading-7 px-2 md:px-0 text-center md:text-start ">
          ...
          by my side. My enthusiasm for learning keeps me excited about bringing
          new ideas to my projects.
        </p>
    ...
    <div className="flex flex-col items-center gap-10">
      ...
      <Section title="Currently working on" Icon={FaCode}>
        <ProjectCard
          ...
          description="A full-stack project built with Next.js, React, Tailwind, Auth.js."
